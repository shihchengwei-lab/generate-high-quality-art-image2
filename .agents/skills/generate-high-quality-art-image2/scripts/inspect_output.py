...
REVISION_SNIPPETS = {
    "hands": "Preserve the same composition and requested identity if any, but redraw the hands with natural anatomy, readable fingers, correct finger count, and stable wrist alignment.",
    "face_identity": "Preserve the composition and lighting, but restore the requested identity traits from the assigned identity reference.",
    "visual_accuracy": "Preserve the strongest parts of the image, but correct literal accuracy: match the requested subject, action, object details, scene, lighting, and reference roles. Remove unrequested elements that made the result inaccurate.",
    ...
    "object_fragmentation": "Preserve the object or material concept, but simplify it into coherent layers with a clear silhouette, intentional detail hierarchy, and no fragmented surfaces.",
    "noisy_effects": "Preserve the requested atmosphere, but reduce glitter noise, edge halos, scattered highlights, and messy translucent overlays. Use controlled effects.",
...
def main() -> None:
    ...
    checklist = [
        ...
        "## Review items",
        "",
        "- [ ] Requested identity or stable subject traits preserved when applicable",
        "- [ ] Literal subject/action/scene accuracy acceptable",
        "- [ ] No unrequested props, people, symbols, labels, or environment elements",
        "- [ ] Reference roles respected",
        "- [ ] Preserve / Change / Ignore contract honored",
        "- [ ] Hands readable",
        "- [ ] Finger count correct",
        "- [ ] Body proportions natural",
        "- [ ] Object and material hierarchy clear",
        "- [ ] No fragmented object or material surfaces",
